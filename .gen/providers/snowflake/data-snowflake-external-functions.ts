// https://www.terraform.io/docs/providers/snowflake/d/external_functions.html
...
export class DataSnowflakeExternalFunctions extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/external_functions.html snowflake_external_functions} Data Source
  *
  ...
  */
  ...
  public externalFunctions(index: string) {
    return new DataSnowflakeExternalFunctionsExternalFunctions(this, 'external_functions', index);
  }
