// https://www.terraform.io/docs/providers/snowflake/d/external_tables.html
...
export class DataSnowflakeExternalTables extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/external_tables.html snowflake_external_tables} Data Source
  *
  ...
  */
  ...
  public externalTables(index: string) {
    return new DataSnowflakeExternalTablesExternalTables(this, 'external_tables', index);
  }
