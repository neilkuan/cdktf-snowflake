// https://www.terraform.io/docs/providers/snowflake/d/file_formats.html
...
export class DataSnowflakeFileFormats extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/file_formats.html snowflake_file_formats} Data Source
  *
  ...
  */
  ...
  public fileFormats(index: string) {
    return new DataSnowflakeFileFormatsFileFormats(this, 'file_formats', index);
  }
