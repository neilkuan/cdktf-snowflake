// https://www.terraform.io/docs/providers/snowflake/d/materialized_views.html
...
export class DataSnowflakeMaterializedViews extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/materialized_views.html snowflake_materialized_views} Data Source
  *
  ...
  */
  ...
  public materializedViews(index: string) {
    return new DataSnowflakeMaterializedViewsMaterializedViews(this, 'materialized_views', index);
  }
