// https://www.terraform.io/docs/providers/snowflake/d/pipes.html
...
export class DataSnowflakePipes extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/pipes.html snowflake_pipes} Data Source
  *
  ...
  */
  ...
  public pipes(index: string) {
    return new DataSnowflakePipesPipes(this, 'pipes', index);
  }
