// https://www.terraform.io/docs/providers/snowflake/d/resource_monitors.html
...
export class DataSnowflakeResourceMonitors extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/resource_monitors.html snowflake_resource_monitors} Data Source
  *
  ...
  */
  ...
  public resourceMonitors(index: string) {
    return new DataSnowflakeResourceMonitorsResourceMonitors(this, 'resource_monitors', index);
  }
