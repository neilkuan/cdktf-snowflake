// https://www.terraform.io/docs/providers/snowflake/d/streams.html
...
export class DataSnowflakeStreams extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/streams.html snowflake_streams} Data Source
  *
  ...
  */
  ...
  public streams(index: string) {
    return new DataSnowflakeStreamsStreams(this, 'streams', index);
  }
