// https://www.terraform.io/docs/providers/snowflake/d/tasks.html
...
export class DataSnowflakeTasks extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/tasks.html snowflake_tasks} Data Source
  *
  ...
  */
  ...
  public tasks(index: string) {
    return new DataSnowflakeTasksTasks(this, 'tasks', index);
  }
