// https://www.terraform.io/docs/providers/snowflake/d/views.html
...
export class DataSnowflakeViews extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/views.html snowflake_views} Data Source
  *
  ...
  */
  ...
  public views(index: string) {
    return new DataSnowflakeViewsViews(this, 'views', index);
  }
