// https://www.terraform.io/docs/providers/snowflake/d/warehouses.html
...
export class DataSnowflakeWarehouses extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/warehouses.html snowflake_warehouses} Data Source
  *
  ...
  */
  ...
  public warehouses(index: string) {
    return new DataSnowflakeWarehousesWarehouses(this, 'warehouses', index);
  }
