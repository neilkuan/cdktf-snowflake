// https://www.terraform.io/docs/providers/snowflake/r/network_policy_attachment.html
...
export interface NetworkPolicyAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly setForAccount?: boolean;
  /**
...
export class NetworkPolicyAttachment extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/r/network_policy_attachment.html snowflake_network_policy_attachment} Resource
  *
