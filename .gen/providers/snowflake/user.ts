// https://www.terraform.io/docs/providers/snowflake/r/user.html
...
export class User extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/r/user.html snowflake_user} Resource
  *
