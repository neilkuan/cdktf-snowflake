// https://www.terraform.io/docs/providers/snowflake/d/masking_policies.html
...
export class DataSnowflakeMaskingPolicies extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/masking_policies.html snowflake_masking_policies} Data Source
  *
  ...
  */
  ...
  public maskingPolicies(index: string) {
    return new DataSnowflakeMaskingPoliciesMaskingPolicies(this, 'masking_policies', index);
  }
