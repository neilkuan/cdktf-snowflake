// https://www.terraform.io/docs/providers/snowflake/d/row_access_policies.html
...
export class DataSnowflakeRowAccessPolicies extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/row_access_policies.html snowflake_row_access_policies} Data Source
  *
  ...
  */
  ...
  public rowAccessPolicies(index: string) {
    return new DataSnowflakeRowAccessPoliciesRowAccessPolicies(this, 'row_access_policies', index);
  }
