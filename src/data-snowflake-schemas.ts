// https://www.terraform.io/docs/providers/snowflake/d/schemas.html
...
export class DataSnowflakeSchemas extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/schemas.html snowflake_schemas} Data Source
  *
  ...
  */
  ...
  public schemas(index: string) {
    return new DataSnowflakeSchemasSchemas(this, 'schemas', index);
  }
