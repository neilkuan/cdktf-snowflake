// https://www.terraform.io/docs/providers/snowflake/d/sequences.html
...
export class DataSnowflakeSequences extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/sequences.html snowflake_sequences} Data Source
  *
  ...
  */
  ...
  public sequences(index: string) {
    return new DataSnowflakeSequencesSequences(this, 'sequences', index);
  }
