// https://www.terraform.io/docs/providers/snowflake/d/stages.html
...
export class DataSnowflakeStages extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/stages.html snowflake_stages} Data Source
  *
  ...
  */
  ...
  public stages(index: string) {
    return new DataSnowflakeStagesStages(this, 'stages', index);
  }
