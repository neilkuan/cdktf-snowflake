// https://www.terraform.io/docs/providers/snowflake/d/storage_integrations.html
...
export class DataSnowflakeStorageIntegrations extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/storage_integrations.html snowflake_storage_integrations} Data Source
  *
  ...
  */
  ...
  public storageIntegrations(index: string) {
    return new DataSnowflakeStorageIntegrationsStorageIntegrations(this, 'storage_integrations', index);
  }
