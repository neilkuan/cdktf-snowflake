// https://www.terraform.io/docs/providers/snowflake/d/tables.html
...
export class DataSnowflakeTables extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/d/tables.html snowflake_tables} Data Source
  *
  ...
  */
  ...
  public tables(index: string) {
    return new DataSnowflakeTablesTables(this, 'tables', index);
  }
