// https://www.terraform.io/docs/providers/snowflake/r/external_function.html
...
export interface ExternalFunctionConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly returnNullAllowed?: boolean;
  /**
  ...
  */
  readonly arg?: ExternalFunctionArg[];
  /**
  * header block
  * 
  ...
  */
  readonly header?: ExternalFunctionHeader[];
}
...
function externalFunctionArgToTerraform(struct?: ExternalFunctionArg): any {
...
function externalFunctionHeaderToTerraform(struct?: ExternalFunctionHeader): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  return {
    name: cdktf.stringToTerraform(struct!.name),
...
export class ExternalFunction extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/snowflake/r/external_function.html snowflake_external_function} Resource
  *
  ...
  */
  ...
  private _arg?: ExternalFunctionArg[];
  public get arg() {
    return this.interpolationForAttribute('arg') as any;
  }
  public set arg(value: ExternalFunctionArg[] ) {
    this._arg = value;
  }
  public resetArg() {
    this._arg = undefined;
  ...
  private _header?: ExternalFunctionHeader[];
  public get header() {
    return this.interpolationForAttribute('header') as any;
  }
  public set header(value: ExternalFunctionHeader[] ) {
    this._header = value;
  }
  public resetHeader() {
